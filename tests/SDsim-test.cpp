...
TEST_CASE("SDsim Tests") {
  ...
  // Make the sim
  std::unique_ptr<DecompSpinSimulation<gfmol::ChebyshevRepr>> p_sim = std::unique_ptr<DecompSpinSimulation<gfmol::ChebyshevRepr>>(new DecompSpinSimulation<gfmol::ChebyshevRepr>(hf, frepr, brepr, nt, ntau, k, dt, MatMaxIter, MatMaxErr, BootMaxIter, BootMaxErr, CorrSteps, mode, 0));
