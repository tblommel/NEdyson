#ifndef GREEN_FUNC_IMPL
#define GREEN_FUNC_IMPL
...
void green_func_tstp::left_multiply(function &ft, cplx weight){
...
void green_func_tstp::right_multiply(function &ft, cplx weight){
