...
void mat_fourier(GREEN &G, const GREEN &Sigma, double mu, const cplx *h0, double beta){
...
// Start Functions =======================================================================================
void GRstart(const INTEG &I, GREEN &G, const GREEN &Sig, const CFUNC &hmf, double mu, double dt){
	// Counters and sizes
...
void GTVstart(const INTEG &I, GREEN &G, const GREEN &Sig, const function &hmf, double mu, double beta, double dt){
	// Counters and sizes
